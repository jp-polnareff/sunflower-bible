package com.leetcode.editor.leetcode.editor.cn;//给你两个单链表的头节点 headA 和 headB ，请你找出并返回两个单链表相交的起始节点。如果两个链表不存在相交节点，返回 null 。
//
// 图示两个链表在节点 c1 开始相交： 
//
// 
...
public class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        ...
        System.out.println(solution.getIntersectionNode2(listNode, listNode).val);
    }
    ...
    public class Solution {
        public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
            ...
            while (!aStack.isEmpty() && !bStack.isEmpty()
                    && aStack.peek() != null && bStack.peek() != null) {
